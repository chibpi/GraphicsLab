...
#define LOG_TAG "MarkerBasedAR/MarkerDetector"
...
{
  LOGD("MarkerDetector::processFrame enter");

  std::vector<Marker> markers;
  LOGD("MarkerDetector::processFrame image cols: %i ",bgraMat.cols);
  ...
  LOGD("MarkerDetector::processFrame exit");
...
bool MarkerDetector::findMarkers(const cv::Mat& bgraMat, std::vector<Marker>& detectedMarkers)
{
	  ...
	  LOGD("MarkerDetector::findMarkers enter");
	  ...
	  LOGD("MarkerDetector::findMarkers exit");
...
bool MarkerDetector::findMarkers(const BGRAVideoFrame& frame, std::vector<Marker>& detectedMarkers)
{
  ...
  return findMarkers(bgraMat, detectedMarkers);
}
...
{
	LOGD("MarkerDetector destructor invoked");
}
